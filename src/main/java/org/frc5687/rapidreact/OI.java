...
public class OI extends OutliersProxy {
    ...
    private Gamepad _driver;
    private Gamepad _operator;
    ...
    public OI() {
        _driver = new Gamepad(0);
        _operator = new Gamepad(1);
...
//        _shootButton = new JoystickButton(_buttonpad, Gamepad.Buttons.Y.getNumber());
        ...
        // rotation joystick
        _intakeButton = new JoystickButton(_operator, Gamepad.Buttons.LEFT_BUMPER.getNumber());
        _autoAim = new JoystickButton(_operator, Gamepad.Buttons.RIGHT_BUMPER.getNumber());
//        _deployRetract = new JoystickButton(_rotation, 3);
        _aimBall = new JoystickButton(_operator, Gamepad.Buttons.START.getNumber());
//        _extraClimb = new JoystickButton(_rotation, 7);

        // translation joystick
        _shootButton = new JoystickButton(_operator, Gamepad.Buttons.B.getNumber());
...
//        return _preloadButton.get();
    ...
    public double getDriveY() {
        ...
        yIn = -getSpeedFromAxis(_driver, Gamepad.Axes.LEFT_Y.getNumber());
...
//        Comment for gamepad control
        xIn = -getSpeedFromAxis(_driver, Gamepad.Axes.LEFT_X.getNumber());
    ...
    public double getRotationX() {
        double speed = -getSpeedFromAxis(_driver, Gamepad.Axes.RIGHT_X.getNumber()); // flipped for anna
