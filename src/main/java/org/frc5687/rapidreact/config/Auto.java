...
public class Auto {
    ...
    public static class FieldPositions {
        ...
        public static Pose2d SAFE_BALL_FOUR = new Pose2d(1.33, 1.14, new Rotation2d(Math.PI));
    ...
    public static class Rotations {
        ...
        public static Rotation2d BALL_TWO_FROM_THIRD = new Rotation2d(Units.degreesToRadians(10));
