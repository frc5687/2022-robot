...
public class Constants {
     ...
     *
     * <p>When looking down at top of robot:
     *
     * <p>N | W -- -- E | S
     *
     * <p>When robot is flipped over on its back:
     *
     * <p>N | E -- -- W | S
     */
     ...
     *
     * <p>- what angle the wheels point, - which direction the wheels turn, - how sensitive the
     * joystick is, - maximum speed and acceleration
     */
    public static class DriveTrain {
        ...
        // PID controller settings
        public static final double STABILIZATION_kP = 5.0;
    ...
    public static class Catapult {
        ...
        public static final double BABY_NEO_RAD_PER_SEC =
                Units.rotationsPerMinuteToRadiansPerSecond(11710);
        public static final double FALCON_RAD_PER_SEC =
                Units.rotationsPerMinuteToRadiansPerSecond(6300);
        ...
        public static final double SPRING_WINCH_DRUM_CIRCUMFERENCE =
                Units.inchesToMeters(0.75) * Math.PI; // meters
        public static final double ARM_WINCH_DRUM_CIRCUMFERENCE =
                Units.inchesToMeters(1.437) * Math.PI; // meters
        ...
        public static final double BALL_INERTIA =
                (2.0 / 3.0) * BALL_MASS * (BALL_RADIUS * BALL_RADIUS); // kg * m^2

        // Physical characteristics
        public static final double POUND_PER_IN_TO_NEWTON_PER_METER =
                0.0057101471627692; // conversion factor
        public static final double SPRING_RATE =
                11.2 * POUND_PER_IN_TO_NEWTON_PER_METER; // Newtons per meter.
        ...
        public static final double ROD_INERTIA =
                (1.0 / 3.0) * ARM_MASS * (ARM_LENGTH * ARM_LENGTH); // kg * m^2
        ...
        public static final double TICKS_TO_METERS =
                SPRING_WINCH_DRUM_CIRCUMFERENCE / (FALCON_TICKS * FALCON_GEAR_REDUCTION);
        public static final double CRUISE_VELOCITY =
                80000; // TODO: Needs to be calibrated via Phoenix tuner
        public static final double ACCELERATION =
                100000; // TODO: Needs to be calibrated via Phoenix tuner
        ...
        //        public static final double MAX_WINCH_VELOCITY_MPS = ((NEO_RAD_PER_SEC /
        // GEAR_REDUCTION)/ (2 * Math.PI)) * ARM_WINCH_DRUM_CIRCUMFERENCE; // m/s
        public static final double MAX_WINCH_VELOCITY_MPS =
    ...
    public static class Climber {
        ...
        public static final double WINCH_DRUM_CIRCUMFERENCE =
                Units.inchesToMeters(1.12) * Math.PI; // meters
        ...
        public static final double MAX_VELOCITY_MPS =
                (MAX_SPEED_WITH_GEAR_BOX / (2 * Math.PI) * WINCH_DRUM_CIRCUMFERENCE);
        ...
        public static final double CLIMB_DRIVE_SPEED =
                -1.0; // The speed of the drivetrain during climbing
        ...
        public static final double STATIONARY_EXTENDED_METERS =
                0.6604; // TODO: Needs to be confirmed
        ...
        public static final long ROCKER_PISTON_SETTLE =
                1000; // The time it takes the robot to rock from one side to the other
        public static final double ARM_STOW_SPEED = -0.3;

        public static final boolean ROCKER_ENCODER_INVERTED =
                false; // TODO: Needs to be calibrated via Phoenix tuner
        public static final boolean STATIONARY_ENCODER_INVERTED =
                false; // TODO: Needs to be calibrated via Phoenix tuner
        ...
        public static final boolean ROCKER_ENCODER_REVERSED =
                false; // TODO: Needs to be calibrated via Phoenix tuner
        public static final boolean STATIONARY_ENCODER_REVERSED =
                false; // TODO: Needs to be calibrated via Phoenix tuner
        public static final double TICKS_TO_METERS =
                0.00000149489; // TODO: Needs to be calibrated via Phoenix tuner
        public static final double CRUISE_VELOCITY =
                50000; // TODO: Needs to be calibrated via Phoenix tuner
        public static final double ACCELERATION =
                90000; // TODO: Needs to be calibrated via Phoenix tuner
    }
